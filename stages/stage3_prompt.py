...
METADATA_TOOL = {
    ...
    "description": "Submit the text-to-video prompt and all YouTube SEO metadata for the video.",
    "input_schema": {
        "type": "object",
        "properties": {
            "video_prompt": {
                "type": "string",
                "description": "Cinematic text-to-video prompt, 120-180 words, single paragraph, 9:16 vertical frame",
            },
            "title": {
                "type": "string",
